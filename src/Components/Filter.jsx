  ...
  return (
    <section className="filter-results-container">
      ...
      <div className="custom-dropdown" data-aos="fade-left">
        ...
        <ul className={`options`} onClick={handleRegionChoice}>
          <li title="All" value="">
            All
          </li>
          <li title="Africa" value="Africa">
            Africa
          </li>
          <li title="Americas" value="Americas">
            Americas
          </li>
          <li title="Asia" value="Asia">
            Asia
          </li>
          <li title="Europe" value="Europe">
            Europe
          </li>
          <li title="Oceania" value="Oceania">
            Oceania
          </li>
        </ul>
      </div>
